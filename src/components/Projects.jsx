...
const projects = [
  ...
  },
  {
    ...
    description: "A pixel-perfect, responsive replication of the Burger King landing page. Demonstrates high-tier CSS grid/flexbox mastery and semantic HTML structure.",
    github: "https://github.com/MithunM20/bking",
    tags: ["HTML5", "Advanced CSS", "Responsive"],
    color: "#EF4444"
  },
];
        ...
        <div className="stacked-card-inner">
          <div className="card-content-left">
            ...
            <div className="project-actions-modern">
              ...
              <a href="#" className="btn-modern-solid" style={{ backgroundColor: project.color }}>
